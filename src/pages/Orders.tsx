...
import { Search, Plus, Eye, Package, MapPin, Phone } from "lucide-react";
...
const mockOrders: Order[] = [
  {
    ...
    address: "Cocody, Rue des Jardins, Abidjan", deliveryDriver: "Koné Mamadou",
  },
  {
    ...
    address: "Plateau, Av. Terrasson, Abidjan", deliveryDriver: "Traoré Issa",
  },
  {
  ...
  },
  {
    ...
    address: "Yopougon, Quartier Millionnaire, Abidjan", deliveryDriver: "Bamba Ali",
  },
  {
  ...
  },
  {
    ...
    total: 33500, status: "delivered", paymentStatus: "paid", date: "2026-02-12T08:00:00",
    address: "Treichville, Av. 12, Abidjan", deliveryDriver: "Koné Mamadou",
  },
  {
    ...
    total: 32000, status: "pending", paymentStatus: "pending", date: "2026-02-11T18:20:00",
  ...
  },
  {
    ...
    total: 62000, status: "preparing", paymentStatus: "paid", date: "2026-02-11T15:10:00",
    address: "Bingerville, Résidence Palm, Abidjan",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: "Total", value: mockOrders.length, color: "text-foreground" },
          { label: "En cours", value: mockOrders.filter(o => ["preparing", "in_transit"].includes(o.status)).length, color: "text-primary" },
          { label: "Livrées", value: mockOrders.filter(o => o.status === "delivered").length, color: "text-accent" },
          { label: "Annulées", value: mockOrders.filter(o => o.status === "cancelled").length, color: "text-destructive" },
        ].map((s) => (
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {selectedOrder.deliveryDriver && (
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <Package size={14} />
                      <span>Livreur : {selectedOrder.deliveryDriver}</span>
                    </div>
                  )}
                </div>
